...
label part1:
    with fade
    s "虽然有些唐突，但容我简单的说明一下吧。"
    s "时间正值文化祭前夕，因某个女人的一时兴起，我们被迫决定了在文化祭上播出自制的电影。剧本大体讲述了一个未来女服务生保护地球的老套故事，至于其为何突然和恐怖元素联系到一起，则是因为我手上这份小册子。"
    s "“北高盂兰盆节历代怪谈集——by神秘研究会”"
    s "虽然叫这个名字，实际上只是把古今中外的恐怖小故事换个装扮并套在自家学校上而已，仅仅是神秘研究会为了文化祭展出鬼屋的预热而已，但——"
    s "意外地，这部小册子在学生间的人气出奇地高。"
    s "负责出刊的社员似乎相当有一套，甚至还拉到了老师的赞助，在得到学校印刷室的使用权后，这部小册子在北高已然是人手一册了。"
    s "自然，凉宫春日也不例外。"
