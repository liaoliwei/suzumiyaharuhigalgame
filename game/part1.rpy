...
label part1:
    with fade
    s "哎呀哎呀，若是打搅众人诸位兴致还请多多见谅。 "
    s "只是故事而已，不必当真."
    s "喜欢闹事的她，口中出现有趣的故事不少."
    s "但如此有趣又能稍微沾点正经的，却实属少数。"
    s "不用做开幕的话，尤为可惜。"
    s "那么，就切入正题吧。"
    s "接下来的两批人会砰地碰撞，究竟能擦出怎样的火花，就算咱也不得而知。"
    s "但如若恳请大家观察两次开篇，未免太过刁难。"
    s "毕竟你看，大部分故事的开篇都是平凡而枯燥的。"
    s "所以，我便在此非常善解人意地出几份题目，以便帮助大家尽快找到自身所属吧！"
    s "哎呀呀，真是温柔，真是良善，连我自己都颇有些不信呢。"
    s "那么——"
    s "第一问题，是和朋友有关的哦，劳烦诸君侧耳聆听："
    s "“你会为了与友人相处，而去刻意地了解某类兴趣爱好吗？”"
    "【会】":
        jump part1.self1
    "【不会】":
        jump part1.self1
label part1.self1:
    s "就是吧！真是豁达呢！"
    s "哎呀，当友人大聊特聊你听不懂的话题时，处境相当尴尬对吧？他那幅难以言表的高涨兴致，自己却完全无法理解，完全就如同局外人一样。"
    s "努力了解的话，就能畅聊相同话题，拉进彼此关系。"
    s "看到为了同自己交流而特意了解新事物的你，友人定会感动不已。"
    s "就算不去了解，想必友人也不是小肚鸡肠的人吧。"
    s "收敛自己的兴奋，缓解你的尴尬，你也能清楚友人如此豁达的心胸。"
    s "虽然之后完全不会提及这类话题，但说来如此友情，真是令人羡慕！"
    s "那接下来是第二问题，依旧如上哦："
    s "“友人做了某种相当不可理喻的事，你会包容理解他吗？”"
    "【会】":
        jump part1.self2
    "【不会】":
        jump part1.self2
label part1.self2:
    s "自然如此！"
    s "哪怕真的不可理喻，但友人终归是友人，脑海里回想他平常的样子就能理解，友人肯定是特殊状况下才为之的吧！"
    s "哎呀，毕竟人总是保守的，作为拥有智慧的高级动物，保全自己无论何时都是驻扎在脑海里的第一要素，因此无论发生何时，只要不是无可挽回，人类都会做出保守规避的选择。"
    s "人总是分为表面与内在的！那位名为弗洛什么的老师也曾提出过各种“我”的理论。所以，哪怕是多么不可理喻的事情，友人干得出来都肯定有其原因，只不过，这个原因你根本就不知道而已，换句话说，和你接触的应该就是表面哦。"
    s "选择包容的话，或许能更加了解友人的本质吧。虽然之前完全都是表面，但没关系，深入了解总需要契机的不是吗？"
    s "无法包容也有其理由，要问硬币的表里那面是“正确的”，恐怕根本无法作答。以此契机了解友人性格的另一面，并在心中提醒自己，不要触及友人的另一种性格，也无偿不是合理的相处。"
    s "哎呀，真是无可奈何呢？"
    s "然后，第三问题："
    s "“一个不认识的家伙突然走进你朋友的圈子，你会同他和睦相处吗？”"
    "【会】":
        jump part1.self3
    "【不会】":
        jump part1.self3
label part1.self3:
    s "呀，非我族类，其心必异。排除异己也永远是人类固有的脾性吧。"
    s "说来，人就是希望能循规蹈矩地度过每天的生物。人类的适应力无比强大，但适应后不愿改变的心理也同样强大。"
    s "哪怕是再小的集团，建立后也会定死关系，一旦打破这种规矩，后果不堪设想。更加可怕的反在于作恶者完全无法意识到是何等严重的事，诸如推理小说中比比皆是的校园暴力，想必也不用咱过多赘述了吧？"
    s "这么一想，不包容到成了正确选项。"
    s "毕竟如果包容的话，说不定自己也会被一同扫地出门……"
    s "第四问题……怎么了？"
    s "问题太过笼统片面？ 好问题。"
    s "诚然如上解答颇有引导性质，但就算义正言辞地反驳，论倒的也仅仅是我个人的提问。"
    s "哎呀哎呀。"
    s "真是。"
    s "无可奈何呢。 "
    s "那么，第四，也是最后一个问题。"
    s "不必担心，这次不会出现之前那些有的没的。"
    s "十分单纯的问题而已。"
    s "被人拯救和拯救他人，你更喜欢那种呢？"
    "【前者】"
    "【后者】"
